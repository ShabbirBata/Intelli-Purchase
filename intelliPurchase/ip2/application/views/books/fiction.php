...
<div class="container">
<h3><span class="glyphicon glyphicon-book"></span> Fiction and Non-Fiction</h3>
<hr>
...
<ol class="breadcrumb">
  ...
  <li class="active">Fiction and Non-Fiction</li>
</ol>
...
<div class="col-sm-12">
	<div class="col-sm-3">
		...
		<hr>
			...
			<input type="hidden" name="book_cat" value="fict">
