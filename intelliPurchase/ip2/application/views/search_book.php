...
<div class="container">
<h3><span class="glyphicon glyphicon-search"></span> Search Results: <?php 
	echo $keyword; ?> <span class="text-muted">(<?php echo $results_count; ?> results found)</span></h3>
<hr>
<ol class="breadcrumb">
  <li><a href="<?php echo base_url(); ?>">Home</a></li>
  <li><a href="<?php echo base_url(); ?>index.php/books/home">Books</a></li>
  <li><a href="<?php echo base_url(); ?>index.php/search/index">Search Results</a></li>
	...
	<div class="row">
		...
		<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
			...
			<div class="product-tags-search">
				...
				<span class="label label-danger"><span class="glyphicon glyphicon-tags"></span> <?php echo $key->book_pubyear; ?></span>
				<br>
				<br>
			</div>
		</div>
